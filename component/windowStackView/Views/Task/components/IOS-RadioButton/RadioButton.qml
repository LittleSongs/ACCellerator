...
Control {
    ...
    //返回开关的状态_swidth，true开，false关
    //返回位置信息,是哪个选项的开关
    signal clickedSwitch(bool _switch,int positionName)
    ...
    MouseArea {
        ...
        onClicked: {
            ...
            console.log("33333333333333点击了开关,checked="+root.checked)
            clickedSwitch(checked,position)
        }
    }
    ...
    Loader {
        ...
        MouseArea {
            ...
            onClicked: {
                root.forceActiveFocus()
                root.checked = !root.checked
                console.log("点击了开关,checked="+root.checked)
                clickedSwitch(checked,position)
//                clicked(checked)
            }
        }
